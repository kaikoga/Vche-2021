...
class Event < ApplicationRecord
  ...
  has_many :event_owners, -> { owned }, class_name: 'EventFollow', dependent: nil
  has_many :owners, through: :event_owners, source: :user

  has_many :event_backstage_members, -> { backstage_member }, class_name: 'EventFollow', dependent: nil
  has_many :backstage_members, through: :event_backstage_members, source: :user

  has_many :event_audiences, -> { audience }, class_name: 'EventFollow', dependent: nil
